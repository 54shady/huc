...
c = fabric.Connection(host='localhost', user='root', port=2222, connect_kwargs={'password': '0'}, config=config)	
...
for i in range(n_tests):
	...
	with c.cd('/root/shared/guestend/simplified-spscq'): # run spscq on guest
